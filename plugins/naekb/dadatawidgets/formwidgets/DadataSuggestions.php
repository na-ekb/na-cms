<?php namespace NAEkb\DadataWidgets\FormWidgets;
...
class DadataSuggestions extends FormWidgetBase
{
    ...
    public function prepareVars()
    {
        ...
        $token = DadataSettings::get('token');
    ...
    {
        $this->addCss('css/dadatasuggestions.css');
        $this->addJs('js/dadatasuggestions.js', ['type' => 'module']);
    }
