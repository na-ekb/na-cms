<?php namespace NAEkb\Pages\Widgets;

use NAEkb\Pages\Widgets\SystemException;
use Str;
use Input;
use Backend\Classes\WidgetBase;
use NAEkb\Pages\Classes\PageList as StaticPageList;
...
class PageList extends WidgetBase
{
     ...
     */
    public $deleteConfirmation = 'naekb.pages::lang.page.delete_confirmation';

    public $noRecordsMessage = 'naekb.pages::lang.page.no_records';

    public $addSubpageLabel = 'naekb.pages::lang.page.add_subpage';
