...
class TemplateList extends WidgetBase
{
     ...
     */
    public $noRecordsMessage = 'naekb.pages::lang.template.no_list_records';

    /**
     * @var string Message to display when the Delete button is clicked.
     */
    public $deleteConfirmation = 'naekb.pages::lang.template.delete_confirm';
    ...
    /**
     * @var array A list of file name patterns to suppress / hide.
     */
    public $ignoreDirectories = [];

    /**
     * @var array Defines sorting properties.
