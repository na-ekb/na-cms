...
class Router
{
     ...
     * @return \NAEkb\Pages\Classes\Page Returns \NAEkb\Pages\Classes\Page object or null if the page cannot be found.
     */
    ...
    protected function getCacheKey($keyName)
    {
         ...
         * Enables modifying the key used to reference cached naekb.pages routes
         *
         * Example usage:
         *
