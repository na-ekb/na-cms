...
use Config;
use Validator;
use NAEkb\Pages\Classes\PageList;
...
class Page extends ContentBase
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->customMessages = [
            'url.regex' => 'naekb.pages::lang.page.invalid_url',
            'url.unique_url' => 'naekb.pages::lang.page.url_not_unique',
        ];
    }
     ...
     * @param \NAEkb\Pages\Classes\Page $parentPage
     */
    ...
    public function getLayoutOptions()
    {
        ...
        if (!$result) {
            $result[null] = Lang::get('naekb.pages::lang.page.layouts_not_found');
        }
