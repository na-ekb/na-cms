<?php namespace NAEkb\Pages\FormWidgets;
...
class MenuItems extends FormWidgetBase
{
    ...
    public $addSubitemLabel = 'naekb.pages::lang.menu.add_subitem';

    public $noRecordsMessage = 'naekb.pages::lang.menu.no_records';

    public $titleRequiredMessage = 'naekb.pages::lang.menuitem.title_required';

    public $referenceRequiredMessage = 'naekb.pages::lang.menuitem.reference_required';

    public $urlRequiredMessage = 'naekb.pages::lang.menuitem.url_required';

    public $cmsPageRequiredMessage = 'naekb.pages::lang.menuitem.cms_page_required';

    public $newItemTitle = 'naekb.pages::lang.menuitem.new_item';
    ...
    public function prepareVars()
    {
        ...
        $widgetConfig = $this->makeConfig('~/plugins/naekb/pages/classes/menuitem/fields.yaml');
    ...
    {
        $this->addJs('js/menu-items-editor.js', 'NAEkb.Pages');
    }
     ...
     * @param \NAEkb\Pages\Classes\MenuItem $item Specifies the menu item
     * @return string
     */
    protected function getReferenceDescription($item)
    {
        ...
        if (isset($this->typeInfoCache[$item->type])) {
            ...
            $result = trans('naekb.pages::lang.menuitem.unknown_type');
        }
    ...
    protected function findReferenceName($search, $typeOptionList)
    {
        ...
        if (!strlen($result)) {
            $result = trans('naekb.pages::lang.menuitem.unnamed');
        }
    ...
    protected function getMenuItemTitle($itemInfo)
    {
        if (is_array($itemInfo)) {
            if (!array_key_exists('title', $itemInfo) || !strlen($itemInfo['title'])) {
                return trans('naekb.pages::lang.menuitem.unnamed');
            }

            return $itemInfo['title'];
        }

        return strlen($itemInfo) ? $itemInfo : trans('naekb.pages::lang.menuitem.unnamed');
    }
