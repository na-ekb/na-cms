<?php return [
    ...
    'snippet' => [
        'menu_label' => 'Snippets',
        'feedback_name' => 'Feedback form',
        'feedback_desc' => 'Allows site users to write to you',
        'meetings_name' => 'Meetings',
        'meetings_desc' => 'Displays and searches meetings',
        'jft_name' => 'Just For Today',
        'jft_desc' => 'Embed a JFT page excerpt with link to full page',
        'jft_link' => 'Link',
        'jft_link_desc' => 'Link to full JFT',
        'jft_title' => 'Daily reflections',
        'jft_read_more' => 'Read more...',
        'share_name' => 'Share',
        'share_desc' => 'Allows you to share the page in various applications',
        'share_text' => 'Save or share<br>the page with those who need it',
        'share_vk' => 'Share VK',
        'share_tg' => 'Share Telegram',
        'share_ok' => 'Share Odnoklassniki',
        'share_wa' => 'Share WhatsApp',
        'share_tw' => 'Share X',
        'share-else' => 'Share via other app',
        'vcard_name' => 'Contacts',
        'vcard_desc' => 'Displays contacts and a download button',
        'vcard_contacts_desc' => 'What types of contacts to display',
        'vcard_download' => 'Download contacts',
        'vcard_phone' => 'Phone',
        'vcard_mail' => 'Email'
    ],
    'component' => [
    ...
    'settings' => [
        ...
        'site_key' => 'Site Key',
        'site_key_comment' => 'Cloudflare Turnstile Site Key <a href="https://www.cloudflare.com/ru-ru/application-services/products/turnstile/" target="_blank">Read more</a>',
        'secret' => 'Secret',
        'secret_comment' => 'Cloudflare Turnstile Secret <a href="https://www.cloudflare.com/ru-ru/application-services/products/turnstile/" target="_blank">Read more</a>',
    ],
    'errors' => [
        'captcha' => 'Captcha Error',
        'empty_msg' => 'Message is required',
        'http_tg' => 'Sending error! Try again later'
    ],
    'success' => [
        'feedback' => 'Successfully sended'
    ]
];
