...
/***/ "./Resources/assets/js/meetings.js":
/*!*****************************************!*\
  !*** ./Resources/assets/js/meetings.js ***!
  \*****************************************/
/*! no exports provided */
...
gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].registerPlugin(gsap_TextPlugin__WEBPACK_IMPORTED_MODULE_3__["TextPlugin"]);
document.addEventListener('DOMContentLoaded', function () {
  popoverRegister();
  addMap();
  var timeEls = [].slice.call(document.querySelectorAll('[data-js="clock"]'));
  ...
  var dateEls = [].slice.call(document.querySelectorAll('[data-js="date"]'));
  ...
  var chooseDayEls = [].slice.call(document.querySelectorAll('[data-js="filterDay"]'));

  if (chooseDayEls.length > 0) {
    chooseDayEls.map(function (chooseDayEl) {
      chooseDayEl.onclick = function (ev) {
        changeDayOfWeek(parseInt(ev.target.dataset.day));
      };
    });
  }

  var changeDayEls = [].slice.call(document.querySelectorAll('[data-js="changeDay"]'));

  if (changeDayEls.length > 0) {
    changeDayEls.map(function (changeDayEl) {
      changeDayEl.onclick = function (ev) {
  ...
  var switchViewEls = [].slice.call(document.querySelectorAll('[data-js="switchView"]'));

  if (switchViewEls.length > 0) {
    switchViewEls.map(function (switchViewEl) {
      switchViewEl.onclick = function (ev) {
...
function updateDates(els) {
  setTimeout(function () {
    var nowTz = new Date(new Date().toLocaleString('en', {
      timeZone: window.timezone
    }));
    var chosenDay = parseInt(document.querySelector('.meeteng-days-menu>li.active>button').dataset.day);

    if (parseInt(document.querySelector('.meeteng-days-menu>li:first-of-type>button').dataset.day) !== nowTz.getDay()) {
      var days = gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].utils.toArray('.meeteng-days-menu>li');
      var state = gsap_Flip__WEBPACK_IMPORTED_MODULE_2__["Flip"].getState(days);
      var ul = days[0].parentNode;
      var first = ul.children.item(0);
    ...
    if (nowTz.getDay() === chosenDay) {
      ...
      var formattedDate = formatter.format(nowTz);
      els.map(function (dateEl) {
...
function changeDayOfWeek(day) {
  ...
  var currentEl = document.querySelector(".meeteng-days-menu>li.active");
  var currentButton = document.querySelector(".meeteng-days-menu>li.active>button");
  var chosenEl = document.querySelector(".meeteng-days-menu [data-js=\"filterDay\"][data-day=\"".concat(day, "\"]")).closest('li');
  var chosenButton = document.querySelector(".meeteng-days-menu [data-js=\"filterDay\"][data-day=\"".concat(day, "\"]"));
  ...
  if (dateEls.length > 0) {
    ...
    var formattedDate = formatter.format(now);
    dateEls.map(function (dateEl) {
      dateEl.innerHTML = formattedDate.replace(/\s*г\./, "");
    });
  }

  updateMeetingsDate(now);
  window.currentBtnAnim = gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(currentButton, {
    duration: 0.3,
    'font-weight': 100,
    'font-size': '1rem',
  ...
  window.chosenBtnAnim = gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(chosenButton, {
    duration: 0.3,
    'font-weight': 700,
    'font-size': '1.5rem',
    onStart: function onStart() {
...
function changeDayMobile(dir) {
  ...
  var formattedDate = formatter.format(now);
  gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to('[data-js="date"]', {
    duration: 0.3,
    text: formattedDate.replace(/\s*г\./, ""),
    ease: 'power2'
  });
  var currentEl = document.querySelector(".meeteng-days-menu>li.active");
  var chosenEl = document.querySelector(".meeteng-days-menu [data-js=\"filterDay\"][data-day=\"".concat(now.getDay(), "\"]")).closest('li');
  window.currentBtnAnim = gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(currentEl, {
    duration: 0.3,
    display: 'none',
    onComplete: function onComplete() {
      currentEl.classList.remove('active');
  ...
  window.chosenBtnAnim = gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(chosenEl, {
    duration: 0.3,
    display: 'list-item',
    onComplete: function onComplete() {
      chosenEl.classList.add('active');
  ...
  console.log(now.toLocaleDateString('ru', {
    weekday: 'long'
  }).capitalize());
}

function updateMeetingsDate(date) {
  var backendFormatter = new Intl.DateTimeFormat('ru', {
    timeZone: window.timezone
  });
  axios__WEBPACK_IMPORTED_MODULE_4___default.a.get(route('widgetAction', {
    name: 'meetings',
    action: 'partialMeetings'
  }), {
    params: {
      date: backendFormatter.format(date)
    }
  }).then(function (response) {
    var allMeetings = document.querySelector('.all-meetings');
    var el = document.createElement('div');
    el.innerHTML = response.data;

    while (el.firstChild) {
      var dNoneEl = el.firstChild;
    ...
    var meetings = gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].utils.toArray('.all-meetings>.meeteng-group');
    var state = gsap_Flip__WEBPACK_IMPORTED_MODULE_2__["Flip"].getState(meetings);
    ...
    gsap_Flip__WEBPACK_IMPORTED_MODULE_2__["Flip"].from(state, {
      ...
      scale: true,
      onComplete: function onComplete() {
        var oldMeetings = document.querySelectorAll('.all-meetings>.meeteng-group:not(.new-meeting)');
        oldMeetings.forEach(function (el) {
          el.parentElement.removeChild(el);
        });
        var newMeetings = document.querySelectorAll('.all-meetings>.meeteng-group.new-meeting');
        newMeetings.forEach(function (el) {
...
function switchToList() {
  var buttonListEl = document.querySelector('.view-buttons>[data-view="list"]');
  gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(buttonListEl, {
    duration: 0.15,
    scale: 0,
    display: 'none',
    onComplete: function onComplete() {
      var buttonMapEl = document.querySelector('.view-buttons>[data-view="map"]');
      gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(buttonMapEl, {
        duration: 0.15,
        scale: 1,
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(mapEl, {
    duration: 0.15,
    scale: 0,
    height: 0,
    onComplete: function onComplete() {
      var allMeetingsEm = document.querySelector('.all-meetings');
      gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(allMeetingsEm, {
        duration: 0.15,
        scale: 1,
        height: 'auto'
      });
...
function createMap() {
  ...
  var types = [new ymaps.control.ListBoxItem({
    data: {
      content: 'Открытая',
      type: 0
    },
  ...
  var typesListBox = new ymaps.control.ListBox({
    data: {
...
/***/ 1:
/*!***********************************************!*\
  !*** multi ./Resources/assets/js/meetings.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/Modules/Site/Resources/assets/js/meetings.js */"./Resources/assets/js/meetings.js");


/***/ })

/******/ });
//# sourceMappingURL=site-meetings.js.map