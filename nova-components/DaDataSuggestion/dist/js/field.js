...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-dadata-suggestion', __webpack_require__(13));
  Vue.component('detail-dadata-suggestion', __webpack_require__(16));
  Vue.component('form-dadata-suggestion', __webpack_require__(19));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__SuggestionList__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__SuggestionList___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__SuggestionList__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_v_click_outside__ = __webpack_require__(48);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        SuggestionList: __WEBPACK_IMPORTED_MODULE_1__SuggestionList___default.a
    },

    directives: {
        clickOutside: __WEBPACK_IMPORTED_MODULE_2_v_click_outside___default.a.directive
    },
    ...
    methods: {
        ...
        changeValue: function changeValue(field, ru, en) {
        ...
        onSelectSuggestion: function onSelectSuggestion(suggestion, suggestions) {
            var suggestionLang = {
                en: null,
                ru: null
            };
            for (var i = 0; i < suggestions.en.length; i++) {
                if (suggestions.en[i].data.kladr_id == suggestion.data.kladr_id) {
                    suggestionLang.en = suggestions.en[i];
                }
            }
            for (var _i = 0; _i < suggestions.ru.length; _i++) {
                if (suggestions.ru[_i].data.kladr_id == suggestion.data.kladr_id) {
                    suggestionLang.ru = suggestions.ru[_i];
                }
            }
            ...
            for (var key in this.field) {
                var fields = ['postalCode', 'country', 'federalDistrict', 'regionType', 'regionTypeFull', 'region', 'areaType', 'areaTypeFull', 'area', 'cityWithType', 'cityType', 'cityTypeFull', 'city', 'cityDistrictWithType', 'cityDistrictType', 'cityDistrictTypeFull', 'cityDistrict', 'settlementWithType', 'settlementType', 'settlementTypeFull', 'settlement', 'streetType', 'streetTypeFull', 'street', 'houseType', 'houseTypeFull', 'house', 'blockType', 'blockTypeFull', 'block', 'flatType', 'flatTypeFull', 'flat', 'geoLat', 'geoLon', 'streetWithType'];
                if (fields.includes(key) && this.field[key] !== undefined) {
                    var kkey = key.replace(/[A-Z]/g, function (letter) {
                        return '_' + letter.toLowerCase();
                    });
                    this.changeValue(this.field[key], suggestionLang.ru.data[kkey], suggestionLang.en.data[kkey]);
                }
            }
        }
    },
...
Component.options.__file = "resources/js/components/SuggestionList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0088f226", Component.options)
  } else {
    hotAPI.reload("data-v-0088f226", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Suggestion__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Suggestion___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__Suggestion__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        Suggestion: __WEBPACK_IMPORTED_MODULE_0__Suggestion___default.a
    },
    props: {
        value: String
    },
    ...
    methods: {
        sendRequest: function sendRequest() {
            ...
            Nova.request({
                ...
                cancelToken: new __WEBPACK_IMPORTED_MODULE_1_axios___default.a.CancelToken(function (c) {
                    _this.cancel = c;
                })
...
Component.options.__file = "resources/js/components/Suggestion.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ef1e56a2", Component.options)
  } else {
    hotAPI.reload("data-v-ef1e56a2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "ap-suggestion",
      attrs: { role: "option" },
      on: { click: _vm.select }
    },
    [
      _c("span", { staticClass: "ap-suggestion-icon" }, [
        _c(
          "svg",
          {
            attrs: {
          ...
          [
            _c("path", {
              attrs: {
                d:
                  "M7 0C3.13 0 0 3.13 0 7c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5C5.62 9.5 4.5 8.38 4.5 7S5.62 4.5 7 4.5 9.5 5.62 9.5 7 8.38 9.5 7 9.5z"
              }
            })
          ]
        )
      ...
      _vm._v(" "),
      _c("span", { staticClass: "ap-address" }, [
        _vm._v(_vm._s(_vm.suggestion.value))
      ])
    ]
  )
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ef1e56a2", module.exports)
  }
}
...
var mergeConfig = __webpack_require__(9);
var validator = __webpack_require__(42);
...
module.exports = {"_from":"axios@>=0.15 <1.0","_id":"axios@0.21.4","_inBundle":false,"_integrity":"sha512-ut5vewkiu8jjGBdqpM44XxjuCjq9LAKeHVmoVfHVzy8eHgxxq8SbAVQNovDA8mVi05kP0Ea/n/UzcSHcTJQfNg==","_location":"/axios","_phantomChildren":{},"_requested":{"type":"range","registry":true,"raw":"axios@>=0.15 <1.0","name":"axios","escapedName":"axios","rawSpec":">=0.15 <1.0","saveSpec":null,"fetchSpec":">=0.15 <1.0"},"_requiredBy":["/form-backend-validation"],"_resolved":"https://registry.npmjs.org/axios/-/axios-0.21.4.tgz","_shasum":"c67b90dc0568e5c1cf2b0b858c43ba28e2eda575","_spec":"axios@>=0.15 <1.0","_where":"/var/www/html/nova-components/DaDataSuggestion/node_modules/form-backend-validation","author":{"name":"Matt Zabriskie"},"browser":{"./lib/adapters/http.js":"./lib/adapters/xhr.js"},"bugs":{"url":"https://github.com/axios/axios/issues"},"bundleDependencies":false,"bundlesize":[{"path":"./dist/axios.min.js","threshold":"5kB"}],"dependencies":{"follow-redirects":"^1.14.0"},"deprecated":false,"description":"Promise based HTTP client for the browser and node.js","devDependencies":{"coveralls":"^3.0.0","es6-promise":"^4.2.4","grunt":"^1.3.0","grunt-banner":"^0.6.0","grunt-cli":"^1.2.0","grunt-contrib-clean":"^1.1.0","grunt-contrib-watch":"^1.0.0","grunt-eslint":"^23.0.0","grunt-karma":"^4.0.0","grunt-mocha-test":"^0.13.3","grunt-ts":"^6.0.0-beta.19","grunt-webpack":"^4.0.2","istanbul-instrumenter-loader":"^1.0.0","jasmine-core":"^2.4.1","karma":"^6.3.2","karma-chrome-launcher":"^3.1.0","karma-firefox-launcher":"^2.1.0","karma-jasmine":"^1.1.1","karma-jasmine-ajax":"^0.1.13","karma-safari-launcher":"^1.0.0","karma-sauce-launcher":"^4.3.6","karma-sinon":"^1.0.5","karma-sourcemap-loader":"^0.3.8","karma-webpack":"^4.0.2","load-grunt-tasks":"^3.5.2","minimist":"^1.2.0","mocha":"^8.2.1","sinon":"^4.5.0","terser-webpack-plugin":"^4.2.3","typescript":"^4.0.5","url-search-params":"^0.10.0","webpack":"^4.44.2","webpack-dev-server":"^3.11.0"},"homepage":"https://axios-http.com","jsdelivr":"dist/axios.min.js","keywords":["xhr","http","ajax","promise","node"],"license":"MIT","main":"index.js","name":"axios","repository":{"type":"git","url":"git+https://github.com/axios/axios.git"},"scripts":{"build":"NODE_ENV=production grunt build","coveralls":"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js","examples":"node ./examples/server.js","fix":"eslint --fix lib/**/*.js","postversion":"git push && git push --tags","preversion":"npm test","start":"node ./sandbox/server.js","test":"grunt test","version":"npm run build && grunt version && git add -A dist && git add CHANGELOG.md bower.json package.json"},"typings":"./index.d.ts","unpkg":"dist/axios.min.js","version":"0.21.4"}
...
var render = function() {
  ...
  return _c(
    "span",
    {
      staticClass: "ap-dropdown-menu active ap-with-places",
      attrs: { role: "listbox", id: "algolia-places-listbox-0" }
    },
    [
      _c("div", { staticClass: "ap-dataset-places" }, [
        _c(
          "span",
          { staticClass: "ap-suggestions" },
          _vm._l(_vm.suggestions[_vm.locale], function(item) {
            return _c("suggestion", {
              key: item.value,
              attrs: { suggestion: item },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0088f226", module.exports)
  }
}
      ...
      _c("template", { slot: "field" }, [
        _c(
          "div",
          {
            ...
            staticClass: "suggestion-wrapper clearfix"
          },
          [
            _c("input", {
              directives: [
            ...
            _c("suggestion-list", {
              ...
              on: { select: _vm.onSelectSuggestion },
              model: {
                value: _vm.value,
                callback: function($$v) {
                  _vm.value = $$v
