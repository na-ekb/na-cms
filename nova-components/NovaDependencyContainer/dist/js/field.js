		...
		registerDependencyWatchers: function registerDependencyWatchers(root, callback) {
			...
			root.$children.forEach(function (component) {
				if (_this.componentIsDependency(component)) {
					...
					_this.dependencyValues[component.field.attribute] = initial_value;
				}
		...
		updateDependencyStatus: function updateDependencyStatus() {
			...
			try {
				for (var _iterator2 = this.field.dependencies[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					...
					// #93 compatability with flexible-content, which adds a generated attribute for each field
					var dependencyValue = this.dependencyValues[this.field.attribute + dependency.field];
...
var render = function() {
  ...
  return _vm.dependenciesSatisfied
    ? _c(
        "div",
        { staticClass: "flex-dom flex-wrap flex" },
        _vm._l(_vm.field.fields, function(childField) {
          return _c("form-" + childField.component, {
            ref: "field-" + childField.attribute,
            refInFor: true,
            tag: "component",
            attrs: {
