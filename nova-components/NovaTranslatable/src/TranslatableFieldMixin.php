...
{
    public function translatable(?string $class = null)
    {
        return function ($overrideLocales = [], $options = []) use ($class) {
            $locales = FieldServiceProvider::getLocales($overrideLocales);
            $component = $this->component;

            $originalResolveCallback = $this->resolveCallback;
            $this->resolveUsing(function ($value, $resource, $attribute) use ($locales, $component, $originalResolveCallback, $class) {
