...
Nova.booting(function (Vue, router) {
    ...
    var registeredViews = JSON.parse('{"detail":{"route":"detail","component":"Detail","name":"meeting-detail-view"}}');
    Object.keys(registeredViews).forEach(function (key) {
        Vue.component(registeredViews[key]['name'], __webpack_require__(3)("./" + registeredViews[key]['component']));
    });
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: Object(__WEBPACK_IMPORTED_MODULE_1_laravel_nova__["mapProps"])(['resourceName', 'resourceId']),

  mixins: [__WEBPACK_IMPORTED_MODULE_1_laravel_nova__["Deletable"], __WEBPACK_IMPORTED_MODULE_1_laravel_nova__["HasCards"], __WEBPACK_IMPORTED_MODULE_1_laravel_nova__["InteractsWithResourceInformation"]],
  ...
  data: function data() {
    return {
      ...
      panels: [],
      actions: [],
      actionValidationErrors: new __WEBPACK_IMPORTED_MODULE_1_laravel_nova__["Errors"](),
  ...
  methods: {
    ...
    handleKeydown: function handleKeydown(e) {
      if (this.resource.authorizedToUpdate && e.target.tagName != 'INPUT' && e.target.tagName != 'TEXTAREA' && e.target.contentEditable != 'true') {
        this.$router.push({
          name: 'edit',
    ...
    getResource: function getResource() {
      ...
      return Object(__WEBPACK_IMPORTED_MODULE_1_laravel_nova__["Minimum"])(Nova.request().get('/nova-api/' + this.resourceName + '/' + this.resourceId)).then(function (_ref2) {
        ...
        for (var i = 0; i < resource.fields.length; i++) {
          if (resource.fields[i].attribute == '' && typeof resource.fields[i].fields != 'undefined') {
            for (var n = 0; n < resource.fields[i].fields.length; n++) {
              _this.resObj[resource.fields[i].fields[n].attribute] = resource.fields[i].fields[n].value;
            }
          } else {
            _this.resObj[resource.fields[i].attribute] = resource.fields[i].value;
          }
        }
    ...
    confirmForceDelete: function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee5() {
        var _this5 = this;
      ...
      _vm._l(_vm.availablePanels, function(panel) {
        return _c(
          "div",
          {
            key: panel.id,
            staticClass: "mb-8",
            attrs: { dusk: _vm.resourceName + "-detail-component" }
          },
          [
            panel.showToolbar
              ? _c(
                  ...
                  [
                    _c("heading", {
                      staticClass: "flex-auto truncate",
                      attrs: { level: 1 }
                    }),
                    _vm._v(" "),
                    _c(
                      "div",
                      { staticClass: "ml-3 flex items-center" },
                      [
              ...
              : _vm._e(),
            _vm._v(" "),
            _c("div", { staticClass: "card mb-6 py-3 px-6 flex-wrap flex" }, [
              _c("div", { staticClass: "flex flex-wrap w-full" }, [
                _c("div", { staticClass: "w-1/2" }, [
                  _c(
                    "div",
                    { staticClass: "flex border-b border-40 flex-col" },
                    [
                      _c("div", { staticClass: "pt-6 w-full" }, [
                        _c("h4", { staticClass: "font-normal text-80" }, [
                          _vm._v("Название группы")
                        ])
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "py-4 break-words w-full" }, [
                        _c("p", { staticClass: "text-90" }, [
                          _vm._v(_vm._s(_vm.resObj.title))
                        ])
                      ])
                    ]
                  )
                ...
                _c("div", { staticClass: "w-1/2" }, [
                  _c(
                    ...
                    [
                      ...
                      _c("div", { staticClass: "py-4 break-words w-full" }, [
                        _c("p", { staticClass: "text-90" }, [
                          _vm._v(_vm._s(_vm.resObj.ComputedField))
                        ])
                      ])
                    ]
                  )
                ...
                _c("div", { staticClass: "w-1/4" }, [
                  _c(
                    ...
                    [
                      ...
                      _c("div", { staticClass: "py-4 break-words w-full" }, [
                        _c("p", { staticClass: "text-90" }, [
                          _vm._v(_vm._s(_vm.resObj.location))
                        ])
                      ])
                    ]
                  )
                ...
                _c("div", { staticClass: "w-1/4" }, [
                  _c(
                    ...
                    [
                      ...
                      _c("div", { staticClass: "py-4 break-words w-full" }, [
                        _c("p", { staticClass: "text-90" }, [
                          _vm._v(_vm._s(_vm.resObj.address))
                        ])
                      ])
                    ]
                  )
                ...
                _c("div", { staticClass: "w-1/4" }, [
                  _c(
                    ...
                    [
                      ...
                      _c("div", { staticClass: "py-4 break-words w-full" }, [
                        _c("p", { staticClass: "text-90" }, [
                          _vm._v(_vm._s(_vm.resObj.address_description))
                        ])
                      ])
                    ]
                  )
